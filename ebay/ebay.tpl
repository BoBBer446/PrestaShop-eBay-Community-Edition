...
<table border="0" cellpadding="0" cellspacing="0" class="ProductPrestashop">
    ...
    <tr class="headerProductPrestashop">
        ...
        <td class="headerRightProductPrestashop">
            <a href="http://feedback.ebay.de/ws/eBayISAPI.dll?ViewFeedback2&userid={literal}{EBAY_IDENTIFIER}{/literal}&sspagename=VIP:feedback&ftab=FeedbackAsSeller">{l s='See our ratings' mod='ebay'}
                <img src="{$module_url|escape:'htmlall':'UTF-8'}views/img/stats.png"
                     alt="{l s='See our ratings' mod='ebay'}" border="0"/></a><br/>
            <a href="http://my.ebay.de/ws/eBayISAPI.dll?AcceptSavedSeller&sellerid={literal}{EBAY_IDENTIFIER}{/literal}&ssPageName=STRK:MEFS:ADDSTR">{l s='Add this shop to my favorites' mod='ebay'}
            ...
            <form action="http://stores.ebay.de/{literal}{EBAY_SHOP}{/literal}/_i.html" method="GET">
